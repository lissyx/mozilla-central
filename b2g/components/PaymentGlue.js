...
PaymentUI.prototype = {
  ...
  confirmPaymentRequest: function confirmPaymentRequest(aRequestId,
    ...
    this._handleSelection = (function _handleSelection(evt) {
      ...
      SystemApp.removeEventListener("mozContentEvent", this._handleSelection);
      this._handleSelection = null;
    }).bind(this);
    SystemApp.addEventListener("mozContentEvent", this._handleSelection);

    SystemApp.sendChromeEvent(detail);
  },
  ...
  showPaymentFlow: function showPaymentFlow(aRequestId,
    ...
    this._loadPaymentShim = (function _loadPaymentShim(evt) {
      ...
      if (msg.errorMsg) {
        SystemApp.removeEventListener("mozContentEvent", this._loadPaymentShim);
    ...
    SystemApp.addEventListener("mozContentEvent", this._loadPaymentShim);
    ...
    this._notifyPayFlowClosed = (function _notifyPayFlowClosed(evt) {
      ...
      SystemApp.removeEventListener("mozContentEvent",
                                  this._notifyPayFlowClosed);
      this._notifyPayFlowClosed = null;
    }).bind(this);
    SystemApp.addEventListener("mozContentEvent",
                               this._notifyPayFlowClosed);
  ...
  cleanup: function cleanup() {
    ...
    if (this._notifyPayFlowClosed) {
      SystemApp.removeEventListener("mozContentEvent", this._notifyPayFlowClosed);
      this._notifyPayFlowClosed = null;
    }
