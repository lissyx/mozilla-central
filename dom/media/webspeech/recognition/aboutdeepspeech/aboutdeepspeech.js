...
var AboutDeepSpeech = {
  ...
  libdeepspeechZip: {
    'linux':  'https://community-tc.services.mozilla.com/api/index/v1/task/project.deepspeech.deepspeech.native_client.v0.6.1.tflite/artifacts/public/libdeepspeech.zip',
    'macosx': 'https://community-tc.services.mozilla.com/api/index/v1/task/project.deepspeech.deepspeech.native_client.v0.6.1.osx-tflite/artifacts/public/libdeepspeech.zip',
    'win':    'https://community-tc.services.mozilla.com/api/index/v1/task/project.deepspeech.deepspeech.native_client.v0.6.1.win-tflite/artifacts/public/libdeepspeech.zip',
  },

  modelsZip: {
    'en-us': 'https://github.com/lissyx/DeepSpeech/releases/download/v0.6.0/en-us.zip',
    'fr-fr': 'https://github.com/lissyx/DeepSpeech/releases/download/v0.6.0/fr-fr.zip',
  },
